...
if grep -i debian /etc/os-release &>/dev/null; then
    ...
    alias wu="sudo systemctl start wpa_supplicant@wlan0.service"
    alias wd="sudo systemctl stop wpa_supplicant@wlan0.service"
    alias eup="sudo ip link set dev eth0 up"
    alias edw="sudo ip link set dev eth0 down"
